...
async function setClientCondition(data) {
    ...
    for (let i = 0; i < data.length; i++) {
       ...
       console.log(clientCondition, "clientCondition")
...
console.log("heyeye123");
    ...
    await fetch("https://t6mcmorgdb.execute-api.us-east-1.amazonaws.com/ABTestActionSelection/getcampaigns?companyName=Reiker&id=")
        .then(response => response.json())
